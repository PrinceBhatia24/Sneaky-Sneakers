...
export default function Offcanvas() {
    ...
    return (
        <div>
            <div className="offcanvas offcanvas-end customoffcanvas" style={{ height: '94vh' }} tabIndex="-1" id="offcanvasCart" aria-labelledby="offcanvasExampleLabel">
                ...
                <div className="offcanvas-body">
                    <div className='container-fluid'>
                        {Cart.map((Data, index) => {
                            return <OffCanvasCard key={index} QuantityShow={true} ProductID={ProductID} Data={Data} />
                        })}
                    </div>
                </div>
                <div className="offcanvas-footer">
                    <div className="card-grid-btn my-1">
                        <Link to="/Checkout" style={{ lineHeight: '2rem' }} className="btn checkbtn py-2 border-dark bg-dark text-white">
                            <div data-bs-dismiss="offcanvas" aria-label="Close" className='d-flex'>
                                <span style={{
                                    width: '63%',
                                    textAlign: 'left'
...
function OffCanvasCard(props) {
    ...
    const { ProductID, DeleteProduct, handleDecrement, handleIncrement } = CartContext();
        ...
        <div className='row mb-5'>
            <div className='col-3 position-relative py-1'>
                <img className='img-fluid CartImg'
                    ...
                    src={`http://localhost:5007/uploads/ProductImage/${Image}`}
                />
